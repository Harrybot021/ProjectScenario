...
Hey , I am GINNY a Group Management Robot.
Made specially for Managing Groups.

This Robot Owner [HARRY](https://t.me/Dev_Harry_02ninja)
Click /help or use button below to find out more about how to use me to my full potential."""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ Push GINNY To Your Group➕️", url=f"t.me/Dev_Ginny_bot?startgroup=true"),
    ],
    [
   ...
   [
        InlineKeyboardButton(
            text="🔥OFFICIAL GROUP🔥", url=f"http://t.me/Empire_Support21")
   ],
   [
        InlineKeyboardButton(
            text="✨ MASTER ✨", url=f"http://t.me/Dev_Harry_02ninja"),
        InlineKeyboardButton(
            text="⚜️ UPDATES ⚜️", url=f"https://t.me/Empire_Network"),
    ],
    [  
        InlineKeyboardButton(text="👥 SUPPORT CHAT 👥", url=f"https://t.me/Empire_Support21"),
    ], 
...
def Masha_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=f""" ℹ️ I'm GINNY, a powerful group management bot built to help you manage your group easily. This Bots Created By AKKU
                 ...
                 Here is the [💾Repository](https://github.com/Harrybot021/ProjectScenario).
                 If you have any question about masha, let us know at [SUPPORT CHAT](https://t.me/Empire_Network).""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..❤️ I'm *GINNY BOT*
                 \nHere is the [Source Code](https://GitHub.com/Harrybot021/ProjectScenario) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=False,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Scenario Back🤧")
        except Unauthorized:
            LOGGER.warning(
